...
faqs:
  - q: "What tyre pressure should I run in soft sand with a Land Cruiser?"
    a: "Drop your tyre pressure to around 1.2 to 1.4 bar as a starting point for most Land Cruisers, and go lower if needed. Carry an onboard compressor so you can re-inflate afterwards — it's essential kit."
  - q: "How do I recover a 4x4 that is stuck in sand?"
    a: "Don't spin the wheels — that digs you in deeper. Clear sand from in front of all four tyres with a shovel, lay sand tracks like MaxTrax in front of the drive wheels, then drive out slowly in low range second gear. If that fails, deflate the tyres further and try again before reaching for a tow strap."
  - q: "What is the safe way to use a winch for vehicle recovery?"
    a: "Always use a tree trunk protector around the anchor, drape a dampener over the centre of the cable, keep the rope layered neatly on the drum, and never stand in line with a cable under tension. A snatch block can double your pulling power, and remember each extra layer of rope on the drum reduces winch capacity by roughly 15%."
  - q: "Why should you never attach a snatch strap to a tow ball?"
    a: "Snatch straps must be attached to rated recovery points, not tow balls or bumpers. A tow ball can shear off under shock load, and unrated attachment points can break — use proper recovery points and let the strap's elasticity do the work with a slow, rolling pull."
  - q: "Are there 4x4 recovery courses in South Africa?"
    a: "Yes — Land Cruiser SA runs a full-day 4x4 recovery course for R4,250 per person, lunch included. A recovery course is described as the single best investment you can make for off-road safety."
---
...
![Land Cruiser 76 cresting a dune in soft sand — tyre pressure is everything](https://pub-6c900fb2e73a4b89bc049099101e4591.r2.dev/images/posts/off-road-recovery-2.jpeg)
...
![Land Cruiser 79 Series — solid recovery anchor points front and rear](https://pub-6c900fb2e73a4b89bc049099101e4591.r2.dev/images/posts/off-road-recovery-5.jpeg)
...
![Vehicle recovery using a snatch strap in the field](https://pub-6c900fb2e73a4b89bc049099101e4591.r2.dev/images/posts/off-road-recovery-3.jpeg)

![Proper winch setup with dampener over the cable](https://pub-6c900fb2e73a4b89bc049099101e4591.r2.dev/images/posts/off-road-recovery-4.jpeg)
