...
Crucially, it sticks to the formula that made the badge famous: a proper body-on-frame ladder chassis — related to Toyota's rugged IMV-0 architecture — rather than a car-based monocoque. In South Africa it arrives as a 2026 model in 2.7-litre petrol 4×4 GX guise, wrapped in chunky, upright styling with round LED headlights, an upright "TOYOTA" grille and short overhangs that nod straight back to the 40 Series and the FJ Cruiser.
