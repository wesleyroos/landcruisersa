...
await db.insert(listings).values([
  {
    ...
    photos: JSON.stringify([
      'https://img.autotrader.co.za/47713484',
      'https://img.autotrader.co.za/47713478',
      'https://img.autotrader.co.za/47713397',
      'https://img.autotrader.co.za/47713379',
      'https://img.autotrader.co.za/47713283',
    ]),
    seller_name: 'Chery Boksburg',
    seller_email: 'info@landcruisersa.co.za',
    seller_phone: '011 000 0000',
    status: 'active',
    source_url: 'https://www.autotrader.co.za/car-for-sale/toyota/land-cruiser-76/2.8/28568296',
    created_at: new Date('2026-06-01'),
  },
  {
    slug: '2025-lc76-28581952',
    title: '2025 Toyota Land Cruiser 76 2.8GD-6 Station Wagon LX',
    model: '76-series',
    year: 2025,
    price: 999900,
    ...
    photos: JSON.stringify([
      'https://img.autotrader.co.za/47587031',
      'https://img.autotrader.co.za/47586968',
      'https://img.autotrader.co.za/47587041',
      'https://img.autotrader.co.za/47586964',
      'https://img.autotrader.co.za/47587010',
    ]),
    seller_name: 'Auto Den Flamwood',
    seller_email: 'info@landcruisersa.co.za',
    seller_phone: '018 000 0000',
    status: 'active',
    source_url: 'https://www.autotrader.co.za/car-for-sale/toyota/land-cruiser-76/2.8/28581952',
    created_at: new Date('2026-06-02'),
  },
  {
    slug: '2019-lc76-28518691',
    ...
    photos: JSON.stringify([
      'https://img.autotrader.co.za/46553993',
      'https://img.autotrader.co.za/46553994',
      'https://img.autotrader.co.za/46554024',
      'https://img.autotrader.co.za/46554101',
      'https://img.autotrader.co.za/46554053',
    ]),
    seller_name: 'Penta Now Centurion',
    seller_email: 'info@landcruisersa.co.za',
    seller_phone: '012 000 0000',
    status: 'active',
    source_url: 'https://www.autotrader.co.za/car-for-sale/toyota/land-cruiser-76/4.5/28518691',
    created_at: new Date('2026-05-28'),
  },
  {
    slug: '2017-prado-28586552',
    ...
    photos: JSON.stringify([
      'https://img.autotrader.co.za/47663588',
      'https://img.autotrader.co.za/47663589',
      'https://img.autotrader.co.za/47663595',
      'https://img.autotrader.co.za/47663597',
      'https://img.autotrader.co.za/47663635',
    ]),
    seller_name: 'Botha and Deysel Executive Motors',
    seller_email: 'info@landcruisersa.co.za',
    seller_phone: '016 000 0000',
    status: 'active',
    source_url: 'https://www.autotrader.co.za/car-for-sale/toyota/land-cruiser-prado/tx/28586552',
    created_at: new Date('2026-06-03'),
  },
  {
    slug: '2020-lc200-28583974',
    ...
    photos: JSON.stringify([
      'https://img.autotrader.co.za/47623285',
      'https://img.autotrader.co.za/47623286',
      'https://img.autotrader.co.za/47623287',
      'https://img.autotrader.co.za/47623288',
      'https://img.autotrader.co.za/47623289',
    ]),
    seller_name: 'Gys Pitzer Motors',
    seller_email: 'info@landcruisersa.co.za',
    seller_phone: '012 000 0001',
    status: 'active',
    source_url: 'https://www.autotrader.co.za/car-for-sale/toyota/land-cruiser-200/vx/28583974',
    created_at: new Date('2026-06-03'),
  },
  {
    slug: '2026-fj-28590629',
    ...
    photos: JSON.stringify([
      'https://img.autotrader.co.za/47730818',
      'https://img.autotrader.co.za/47730803',
      'https://img.autotrader.co.za/47730814',
      'https://img.autotrader.co.za/47730805',
      'https://img.autotrader.co.za/47730807',
    ]),
    seller_name: 'Heyhalfway Hillcrest',
    seller_email: 'info@landcruisersa.co.za',
    seller_phone: '031 000 0000',
    status: 'active',
    source_url: 'https://www.autotrader.co.za/car-for-sale/toyota/land-cruiser-fj/2.7/28590629',
    created_at: new Date('2026-06-04'),
  },
  {
    slug: '2026-fj-28587857',
    ...
    photos: JSON.stringify([
      'https://img.autotrader.co.za/47684637',
      'https://img.autotrader.co.za/47684639',
      'https://img.autotrader.co.za/47684641',
      'https://img.autotrader.co.za/47684642',
      'https://img.autotrader.co.za/47684643',
    ]),
    seller_name: 'Auto Investments North Coast',
    seller_email: 'info@landcruisersa.co.za',
    seller_phone: '032 000 0000',
    status: 'active',
    source_url: 'https://www.autotrader.co.za/car-for-sale/toyota/land-cruiser-fj/2.7/28587857',
    created_at: new Date('2026-06-04'),
  },
  {
    slug: '2015-lc79-28587192',
    ...
    photos: JSON.stringify([
      'https://img.autotrader.co.za/47514780',
      'https://img.autotrader.co.za/47514758',
      'https://img.autotrader.co.za/47514749',
      'https://img.autotrader.co.za/47514773',
      'https://img.autotrader.co.za/47514753',
    ]),
    seller_name: 'Kloof Car Sales',
    seller_email: 'info@landcruisersa.co.za',
    seller_phone: '031 000 0001',
    status: 'active',
    source_url: 'https://www.autotrader.co.za/car-for-sale/toyota/land-cruiser-79/4.5/28587192',
    created_at: new Date('2026-05-30'),
  },
  {
    slug: '2026-lc79-28587583',
    ...
    photos: JSON.stringify([
      'https://img.autotrader.co.za/47679923',
      'https://img.autotrader.co.za/47679892',
      'https://img.autotrader.co.za/47679972',
      'https://img.autotrader.co.za/47679932',
      'https://img.autotrader.co.za/47680042',
    ]),
    seller_name: 'Autorama Klerksdorp',
    seller_email: 'info@landcruisersa.co.za',
    seller_phone: '018 000 0001',
    status: 'active',
    source_url: 'https://www.autotrader.co.za/car-for-sale/toyota/land-cruiser-79/4.0/28587583',
    created_at: new Date('2026-06-05'),
  },
  {
    slug: '2024-prado-28572116',
    ...
    photos: JSON.stringify([
      'https://img.autotrader.co.za/46181047',
      'https://img.autotrader.co.za/46181134',
      'https://img.autotrader.co.za/46181071',
      'https://img.autotrader.co.za/46181157',
      'https://img.autotrader.co.za/46181059',
    ]),
    seller_name: 'Penta Now Centurion',
    seller_email: 'info@landcruisersa.co.za',
    seller_phone: '012 000 0002',
    status: 'active',
    source_url: 'https://www.autotrader.co.za/car-for-sale/toyota/land-cruiser-prado/tx/28572116',
    created_at: new Date('2026-06-05'),
  },
]);

console.log('Seeded 10 listings with confirmed photos and specs.');
process.exit(0);
